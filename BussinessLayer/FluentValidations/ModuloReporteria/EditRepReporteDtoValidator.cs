...
{
    public class EditRepReporteDtoValidator : AbstractValidator<EditRepReporteDto>
    {
        public EditRepReporteDtoValidator()
        {
            RuleFor(x => x.Id)
                .NotNull().WithMessage("El ID del reporte es obligatorio.")
