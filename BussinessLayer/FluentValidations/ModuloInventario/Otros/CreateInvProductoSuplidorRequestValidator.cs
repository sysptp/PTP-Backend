...
{
    public class CreateInvProductoSuplidorRequestValidator : AbstractValidator<CreateInvProductoSuplidorDTO>
    {
        private readonly IProductoService _productoService;
        private readonly ISuplidoresService _suplidoresService;
        private readonly IMonedasService _monedasService;

        public CreateInvProductoSuplidorRequestValidator(IProductoService productoService,
