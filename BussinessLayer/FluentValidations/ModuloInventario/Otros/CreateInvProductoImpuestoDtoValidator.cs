...
{
    public class CreateInvProductoImpuestoDtoValidator : AbstractValidator<CreateInvProductoImpuestoDto>
    {
        private readonly IProductoService _productoService;
        private readonly IImpuestosService _impuestosService;
        public CreateInvProductoImpuestoDtoValidator(IProductoService productoService,
