...
namespace PTP_API.Controllers.Empresa
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public CompanyController(IGnEmpresaservice scEmp001Service)
        {
        ...
        public async Task<IActionResult> Add([FromBody] GnEmpresaRequest request)
        {
            ...
            try
            {
                var empresa = await _scEmp001Service.Add(request);
                return Ok(Response<GnEmpresaResponse>.Created(empresa, "Empresa creada correctamente."));
            }
            catch (Exception ex)
            {
