...
namespace PTP_API.Controllers.ModuloInventario.Almacen
{
    ...
    public class MovimientoSucursalDetalleController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get([FromQuery] int? id)
        {
            ...
            {
                return StatusCode(500, Response<string>.ServerError("Ocurrió un error al obtener el Movimiento Sucursal Detalle. Por favor, intente nuevamente."));
            }
        }
        ...
        public async Task<IActionResult> Add([FromBody] InvMovimientoSucursalDetalleRequest request)
        {
            ...
            {
                return StatusCode(500, Response<string>.ServerError("Ocurrió un error al crear un Movimiento Sucursal Detalle. Por favor, intente nuevamente."));
            }
        }
        ...
        public async Task<IActionResult> Update(int id, [FromBody] InvMovimientoSucursalDetalleRequest saveDto)
        {
            ...
            {
                return StatusCode(500, Response<string>.ServerError("Ocurrió un error al actualizar el Movimiento Sucursal Detalle. Por favor, intente nuevamente."));
            }
        }
        [HttpDelete("{id}")]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            {
                return StatusCode(500, Response<string>.ServerError("Ocurrió un error al eliminar el Movimiento Sucursal Detalle. Por favor, intente nuevamente."));
            }
        }
    }
}
